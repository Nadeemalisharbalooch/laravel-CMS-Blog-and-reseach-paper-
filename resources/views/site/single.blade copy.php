							...
							<ul class="comment-tree list-unstyled">
								<li class="mb-5">
									<div class="comment-area-box">
										<img loading="lazy" alt="comment-author" src="{{asset('storage/auth/posts/'.$blog->gallery->image)}}" class="img-fluid float-left mr-3 mt-2">
									...
									<div class="form-group">
							<textarea name="commnet" id="commnet" cols="20" rows="3" class="form-control"></textarea>
...
@else
<h3 class="text-danger text-center p-5" >unable to locate the blog,please go back and again try</h3>
@endif
